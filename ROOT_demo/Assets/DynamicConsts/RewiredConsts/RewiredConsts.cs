// <auto-generated>
// Rewired Constants
// This list was generated on 2021/6/8 16:08:56
...
namespace RewiredConsts {
    public static partial class Action {
        ...
        public static partial class Button {
            ...
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "Action that mainly based on button", friendlyName = "RotateUnit")]
            public const int RotateUnit = 7;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "Action that mainly based on button", friendlyName = "request shop raise one tier")]
            public const int ShopTierUp = 40;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "Action that mainly based on button", friendlyName = "request shop lower one tier")]
        ...
        public static partial class Cursor {
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "A category that dedicate to Cursor Actions", friendlyName = "CursorUp")]
            public const int CursorUp = 1;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "A category that dedicate to Cursor Actions", friendlyName = "CursorDown")]
            public const int CursorDown = 2;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "A category that dedicate to Cursor Actions", friendlyName = "CursorLeft")]
            public const int CursorLeft = 3;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "A category that dedicate to Cursor Actions", friendlyName = "CursorRight")]
            public const int CursorRight = 4;
        }
        public static partial class Functional {
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func0")]
            public const int Func0 = 12;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func1")]
            public const int Func1 = 13;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func2")]
            public const int Func2 = 14;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func3")]
            public const int Func3 = 15;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func4")]
            public const int Func4 = 16;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func5")]
            public const int Func5 = 17;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func6")]
            public const int Func6 = 18;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func7")]
            public const int Func7 = 19;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func8")]
            public const int Func8 = 20;
            [Rewired.Dev.ActionIdFieldInfo(categoryName = "For all numeric keys at is multipurpose", friendlyName = "Func9")]
