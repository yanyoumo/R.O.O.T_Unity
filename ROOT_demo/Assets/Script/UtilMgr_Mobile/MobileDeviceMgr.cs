...
namespace ROOT
{
    public static class MobileDeviceMgr
    {
        public static (SupportedScreenRatio,InputScheme) AdaptMobileScreen()
        {
            SupportedScreenRatio detectedScreenRatio;
            ...
            return (detectedScreenRatio,InputScheme.TouchScreen);
        }
