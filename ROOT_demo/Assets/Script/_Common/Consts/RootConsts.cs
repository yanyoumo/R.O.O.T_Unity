...
namespace ROOT.Consts
{
    ...
    public static class StaticPlayerPrefName
    {
        ...
        public static readonly string Level_SelectionPanel_PosX = "LevelSelectionPanelPosX";
        public static readonly string Level_SelectionPanel_PosY = "LevelSelectionPanelPosY";
